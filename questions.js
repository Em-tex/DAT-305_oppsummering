window.rawQuestions = [
    ...
    { mod: 1, q: "Deep Learning (DL) is distinct from Machine Learning (ML) because...", options: ["It uses Neural Networks with many layers", "It requires no data", "It is slower", "It is only for images"], a: 0, exp: "Deep Learning refers specifically to multi-layered (Deep) Neural Networks." },
    ...
    { mod: 3, q: "Support Vectors in SVM (Support Vector Machine) are...", options: ["The centroids", "The outliers", "Data points closest to the hyperplane", "The kernel functions"], a: 2, exp: "These critical points define the margin boundary." },
